...
def print_bar_chart(data, mark):
    dat = Counter(data)
    for k, v in sorted(dat.items(), key=lambda x: x[1], reverse=True):
        print(f'{k.ljust(1+len(max(dat, key=len)))}|{v*mark}')
