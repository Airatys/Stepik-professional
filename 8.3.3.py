# В первый год в пруду живет 7777 лягушек. Каждый год из пруда вылавливают 3030 лягушек, а оставшиеся размножаются, и их становится в три раза больше.
# Так, количество лягушек kk-й год  может быть описано формулой:
# Fk=3(Fk−1−30)
# Fk​=3(Fk−1​−30)
